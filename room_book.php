...
<body style="background-image: url(IMAGES/regimg.webp);">
	<?php
		...
		if(!$conn)  
		...
		else
			{
				...
				$query2="INSERT INTO room_book(User_Id,Name,Room_name,Arrival,Departure,Rooms,Adults,Children) VALUES('$user_id','$name','$room_name','$arrival','$departure','$rooms','$adults','$children')";
	...
	?>
				...
				<h3 style=" font-family:Century Schoolbook; color:black;"> Your Room Booking Details Are As Follows:</h2><br/>
