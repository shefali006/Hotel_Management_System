...
<body style="background-image: url(IMAGES/regimg.webp);">
	<?php
		...
		if(!$conn)  
		...
		else
			{
				...
				$query2="INSERT INTO event_book(User_Id,Name,Hall_name,Event_name,Guest,Event_date,Start_time,End_time) VALUES('$user_id','$name','$hall_name','$event_name','$guest','$event_date','$start_time','$end_time')";
	...
	?>
				...
				<h2 style=" font-family:Century Schoolbook; color:black;"> Congratulations!!</h4><br/>
				<h3 style=" font-family:Century Schoolbook; color:black;"> Your Hall Booking Details Are As Follows:</h2><br/>
